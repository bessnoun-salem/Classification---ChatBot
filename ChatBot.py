...
try:
    df = pd.read_csv("Sheet_1.csv", usecols=['response_id', 'class', 'response_text'], encoding='latin-1')
    print("\nAperçu des données:")
    print(df.head())
except FileNotFoundError:
    print("Fichier Sheet_1.csv non trouvé. Utilisation de données par défaut.")
